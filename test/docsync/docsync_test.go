...
var docTreeIgnored = []string{"cmd", "examples", "gascity-dashboard", "gc-plans", "gc-wisp-cer-prepare-build-context", "internal", "plans", "scripts", "test", "tmp", "tools", "workflow-artifacts"}
