...
export interface components {
    schemas: {
        ...
        TypedEventStreamEnvelopeSessionLivenessStale: {
            actor: string;
            message?: string;
            payload: components["schemas"]["SessionLivenessStalePayload"];
            /** Format: int64 */
            seq: number;
            subject?: string;
            /** Format: date-time */
